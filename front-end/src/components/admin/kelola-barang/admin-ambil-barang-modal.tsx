...
interface AdminAmbilBarangModalProps {
    isOpen: boolean;
    onClose: () => void;
    onSuccess: () => void;
...
const AdminAmbilBarangModal: React.FC<AdminAmbilBarangModalProps> = ({ 
    ...
    // Fetch users and stok when modal opens
    useEffect(() => {
        if (isOpen) {
            fetchData();
            // Reset state
            ...
            >
                ...
                <div className="flex items-center justify-between p-4 border-b border-[#333]">
                    <div className="flex items-center gap-2">
                        ...
                        <h2 className="text-white font-bold text-lg">Ambil Barang untuk User</h2>
                    </div>
                    <button 
                        onClick={onClose}
                    ...
                    <div className="p-4 border-t border-[#333] bg-[#1a1a1a]">
                        ...
                        <div className="flex gap-2">
                            ...
                            <button
                                ...
                                disabled={submitting || !selectedUserId || selectedItems.length === 0}
...
export default AdminAmbilBarangModal;
